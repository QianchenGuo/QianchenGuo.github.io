...
export const copy = {
  zh: {
    ...
    metrics: [['40','知乎文章'],['18','知乎回答'],['50万+','公开技术写作字数'],['200+','零阶优化 MPC 社群成员']],
  ...
  en: {
    ...
    metrics: [['40','Zhihu articles'],['18','Zhihu answers'],['500k+','Chinese characters published'],['200+','Zero-order Optimization MPC community']],
