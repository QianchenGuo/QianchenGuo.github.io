...
export const copy = {
  zh: {
    ...
    metrics: [['73','知乎文章'],['19','知乎回答'],['50万+','公开技术写作字数'],['200+','零阶优化 MPC 社群成员']],
  ...
  en: {
    ...
    metrics: [['73','Zhihu articles'],['19','Zhihu answers'],['500k+','Chinese characters published'],['200+','Zero-order Optimization MPC community']],
